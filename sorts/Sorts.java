...
//----------------------------------------------------------------------------
//Sorts.java               by Dale/Joyce/Weems and Prianca Padmanabhan                
//
...
public class Sorts {
	static long selectioncomparisons = 0;
	static long selectionswaps = 0;
	static long shortbubbleswaps = 0;
	static long shortbubblecomparisons=0;
	static long insertionsortcomparisons = 0;
	static long insertionswaps = 0;
	static long mergecomparisons = 0;
	static long mergeswaps = 0;
	static long quickcomparisons=0;
	static long quickswaps = 0;
	static long heapcomparisons =0;
	static long heapswaps = 0;
	...
	public static void main(String[] args) 
	{
		...
		while (i <= 1000000)
		{
			...
			//quickSort(0, SIZE - 1);
			heapSort();
			System.out.println(heapswaps); 
			heapswaps = 0;
			//selectioncomparisons = 0;
			//shortbubblecomparisons = 0;
			//mergecomparisons = 0;
			...
			//mergeswaps = 0;
			//heapcomparisons = 0;
			//System.out.println(mergecomparisons);
			//System.out.println(heapcomparisons);
